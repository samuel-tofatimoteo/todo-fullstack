...
export async function seed(knex) {
  ...
  await knex('tasks').insert([
    ...
    {id: 5, name: 'finish app', details: 'deploy fullstack app with database', priority: 2, completed: false},
    ...
    {id: 9, name: 'knitting', details: 'knit a sweater', priority: 2, completed: false},
  ]);
}
